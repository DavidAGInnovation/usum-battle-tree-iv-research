...
theorem remains outside the present analysis; the retail source-defined writer
theorem is closed by the field-sensitive whole-program verifier
[`scripts/verify-retail-ai-writer-whole-program.py`](../scripts/verify-retail-ai-writer-whole-program.py)
and artifact [`recovered/retail-ai-writer-whole-program.json`](../recovered/retail-ai-writer-whole-program.json).
